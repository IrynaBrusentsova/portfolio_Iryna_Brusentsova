...
const langArr = {
  ...
  "about-description-1": {
    ua: "Привіт, я - Іра! Розповім про свій шлях до професії, назву якої колись навіть не знала. Багато років я займалася розробкою креслень та технологій обробки і контролю деталей з металу. От працюєш, наче добре виходить, але хотілося іншого, більш цікавого для себе, неординарного. Коли я про це замислювалася, в маленькому місті, де я тоді жила, навіть не знали такої професії, як веб-розробник). Це типу як гапакс у шкільній літературі. Що вже казати про стабільний інтернет, який працював від домашнього телефону. Доречі, телефон теж був не у всіх))",
